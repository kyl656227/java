...
public class UsingPrintf {
    public static void main (String[]args){
        ...
        // 즉, 문자열 사이에 변수의 값ㅇ르 삽입하는 방법.

        // println과 위 변수들을 이용하여 문장을 완성하시오.
        // 문장: 홍길동의 나이는 22세이며, 키는 176.5cm이고 혈액형은 A형이고
        // 성별은 남자

        System.out.println (name + "의 나이는" + age + "세 이며, 키는"
                + height + "cm이고 혈액형은" + bloodType + "형이고 성별은 남자인가?" + isMan );
